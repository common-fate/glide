...
func Dotenv() error {
	...
	myEnv["GRANTER_LAMBDA_EXECUTION_ROLE_ARN"] = o.GranterLambdaExecutionRoleARN
	myEnv["ACCESS_HANDLER_REST_API_LAMBDA_EXECUTION_ROLE_ARN"] = o.AccessHandlerRestAPILambdaExecutionRoleARN
