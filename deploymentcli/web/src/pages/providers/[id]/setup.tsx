...
import { useGetProvider } from "../../../utils/local-client/deploymentcli/deploymentcli";
import { ProviderSetup } from "../../../utils/local-client/types/openapi.yml";
...
const Page = () => {
  ...
  //   todo fix me once api is stable:
  ...
  // const navigate = useNavigate()
  // to go back in react-location tan stack
  //   const handleGoBack = () => {
        ...
        <Center borderBottom="1px solid" borderColor="neutrals.200" h="80px">
          ...
          <Text as="h4" textStyle="Heading/H4">
            {provider !== undefined && (
              ...
              `Setting up the ${provider.team}/${provider.name} provider`}
          </Text>
        </Center>
        <Container
          my={12}
      ...
      >
        ...
        <Text as="h4" textStyle="Heading/H4">
          {provider !== undefined && (
            ...
            `Setting up the ${provider.name} provider`}
        </Text>
        {data && (
          <HStack
            spacing={3}
