...
export const adminListAccessRules = (
  ...
  return customInstanceCommonfate<ListAccessRulesDetailResponseResponse>(
    { url: `/api/v1/admin/access-rules`, method: "get", params },
    options
  );
};

export const getAdminListAccessRulesKey = (
  params?: AdminListAccessRulesParams
) => [`/api/v1/admin/access-rules`, ...(params ? [params] : [])];

export type AdminListAccessRulesQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminListAccessRules>>
>;
...
export const useAdminListAccessRules = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListAccessRulesKey(params) : null));
...
export const getAdminGetAccessRuleKey = (ruleId: string) => [
  `/api/v1/admin/access-rules/${ruleId}`,
];

export type AdminGetAccessRuleQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetAccessRule>>
>;
export type AdminGetAccessRuleQueryError = ErrorType<ErrorResponseResponse>;

export const useAdminGetAccessRule = <
...
>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetAccessRuleKey(ruleId) : null));
...
export const adminUpdateAccessRule = (
  ...
  return customInstanceCommonfate<AccessRuleDetail>(
    {
      url: `/api/v1/admin/access-rules/${ruleId}`,
      method: "put",
      headers: { "Content-Type": "application/json" },
      data: createAccessRuleRequestBody,
    },
...
export const getAdminGetAccessRuleVersionsKey = (ruleId: string) => [
  `/api/v1/admin/access-rules/${ruleId}/versions`,
];

export type AdminGetAccessRuleVersionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetAccessRuleVersions>>
>;
...
export const useAdminGetAccessRuleVersions = <TError = ErrorType<void>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetAccessRuleVersionsKey(ruleId) : null));
...
export const adminGetAccessRuleVersion = (
  ...
  return customInstanceCommonfate<AccessRuleDetail>(
    {
      url: `/api/v1/admin/access-rules/${ruleId}/versions/${version}`,
      method: "get",
    },
    options
  );
...
export const getAdminGetAccessRuleVersionKey = (
  ruleId: string,
  version: string
) => [`/api/v1/admin/access-rules/${ruleId}/versions/${version}`];

export type AdminGetAccessRuleVersionQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetAccessRuleVersion>>
>;
export type AdminGetAccessRuleVersionQueryError =
  ErrorType<ErrorResponseResponse>;

export const useAdminGetAccessRuleVersion = <
  TError = ErrorType<ErrorResponseResponse>
>(
  ruleId: string,
  version: string,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() =>
      isEnabled ? getAdminGetAccessRuleVersionKey(ruleId, version) : null);
  const swrFn = () =>
    adminGetAccessRuleVersion(ruleId, version, requestOptions);
...
export const getAdminGetDeploymentVersionKey = () => [
  `/api/v1/admin/deployment/version`,
];

export type AdminGetDeploymentVersionQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetDeploymentVersion>>
>;
export type AdminGetDeploymentVersionQueryError = ErrorType<unknown>;

export const useAdminGetDeploymentVersion = <
...
>(options?: {
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetDeploymentVersionKey() : null));
...
export const adminListRequests = (
  ...
  return customInstanceCommonfate<ListRequestsResponseResponse>(
    { url: `/api/v1/admin/requests`, method: "get", params },
    options
  );
};

export const getAdminListRequestsKey = (params?: AdminListRequestsParams) => [
...
export const useAdminListRequests = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListRequestsKey(params) : null));
...
export const getAdminListUsersKey = (params?: AdminListUsersParams) => [
  `/api/v1/admin/users`,
  ...(params ? [params] : []),
];
...
export const useAdminListUsers = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListUsersKey(params) : null));
...
export const adminListGroups = (
  ...
  return customInstanceCommonfate<ListGroupsResponseResponse>(
    { url: `/api/v1/admin/groups`, method: "get", params },
    options
  );
};

export const getAdminListGroupsKey = (params?: AdminListGroupsParams) => [
  `/api/v1/admin/groups`,
  ...(params ? [params] : []),
];
...
export const useAdminListGroups = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListGroupsKey(params) : null));
...
export const getAdminGetGroupKey = (groupId: string) => [
  `/api/v1/admin/groups/${groupId}`,
];

export type AdminGetGroupQueryResult = NonNullable<
...
export const useAdminGetGroup = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetGroupKey(groupId) : null));
...
export const useAdminListProviders = <
  TError = ErrorType<ErrorResponseResponse>
>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof adminListProviders>>,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListProvidersKey() : null));
...
export const getAdminGetProviderKey = (providerId: string) => [
  `/api/v1/admin/providers/${providerId}`,
];

export type AdminGetProviderQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetProvider>>
>;
...
export const useAdminGetProvider = <TError = ErrorType<ErrorResponseResponse>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetProviderKey(providerId) : null));
...
export const getAdminGetProviderArgsKey = (providerId: string) => [
  `/api/v1/admin/providers/${providerId}/args`,
];

export type AdminGetProviderArgsQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetProviderArgs>>
>;
export type AdminGetProviderArgsQueryError = ErrorType<ErrorResponseResponse>;

export const useAdminGetProviderArgs = <
  TError = ErrorType<ErrorResponseResponse>
>(
  providerId: string,
  options?: {
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetProviderArgsKey(providerId) : null));
...
export const adminListProviderArgOptions = (
  ...
  return customInstanceCommonfate<ArgOptionsResponseResponse>(
    {
      url: `/api/v1/admin/providers/${providerId}/args/${argId}/options`,
      method: "get",
      params,
    },
    options
...
export const getAdminListProviderArgOptionsKey = (
  providerId: string,
  argId: string,
  params?: AdminListProviderArgOptionsParams
) => [
...
export type AdminListProviderArgOptionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminListProviderArgOptions>>
>;
export type AdminListProviderArgOptionsQueryError =
  ErrorType<ErrorResponseResponse>;

export const useAdminListProviderArgOptions = <
  TError = ErrorType<ErrorResponseResponse>
>(
  providerId: string,
  argId: string,
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getAdminListProviderArgOptionsKey(providerId, argId, params)
        : null);
  const swrFn = () =>
    adminListProviderArgOptions(providerId, argId, params, requestOptions);
...
export const getAdminListProvidersetupsKey = () => [
  `/api/v1/admin/providersetups`,
];

export type AdminListProvidersetupsQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminListProvidersetups>>
>;
export type AdminListProvidersetupsQueryError = ErrorType<unknown>;

export const useAdminListProvidersetups = <
  TError = ErrorType<unknown>
>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof adminListProvidersetups>>,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListProvidersetupsKey() : null));
...
export const adminCreateProvidersetup = (
  ...
  return customInstanceCommonfate<ProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetups`,
      method: "post",
      headers: { "Content-Type": "application/json" },
...
export const getAdminListProvidersetupsv2Key = () => [
  `/api/v1/admin/providersetupsv2`,
];

export type AdminListProvidersetupsv2QueryResult = NonNullable<
  Awaited<ReturnType<typeof adminListProvidersetupsv2>>
>;
export type AdminListProvidersetupsv2QueryError = ErrorType<unknown>;

export const useAdminListProvidersetupsv2 = <
  TError = ErrorType<unknown>
>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof adminListProvidersetupsv2>>,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminListProvidersetupsv2Key() : null));
...
export const adminCreateProvidersetupv2 = (
  ...
  return customInstanceCommonfate<ProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetupsv2`,
      method: "post",
      headers: { "Content-Type": "application/json" },
...
export const getAdminGetProvidersetupKey = (providersetupId: string) => [
  `/api/v1/admin/providersetups/${providersetupId}`,
];

export type AdminGetProvidersetupQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetProvidersetup>>
>;
...
export const useAdminGetProvidersetup = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetProvidersetupKey(providersetupId) : null));
...
export const adminDeleteProvidersetupv2 = (
  ...
  return customInstanceCommonfate<ProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetups/${providersetupId}`,
      method: "delete",
    },
    options
  );
...
export const getAdminGetProvidersetupv2Key = (providersetupId: string) => [
  `/api/v1/admin/providersetupsv2/${providersetupId}`,
];

export type AdminGetProvidersetupv2QueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetProvidersetupv2>>
>;
...
export const useAdminGetProvidersetupv2 = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetProvidersetupv2Key(providersetupId) : null));
...
export const adminDeleteProvidersetup = (
  ...
  return customInstanceCommonfate<ProviderSetupV2ResponseResponse>(
    {
      url: `/api/v1/admin/providersetupsv2/${providersetupId}`,
      method: "delete",
    },
    options
  );
...
export const adminGetProvidersetupInstructions = (
  ...
  return customInstanceCommonfate<ProviderSetupInstructions>(
    {
      url: `/api/v1/admin/providersetups/${providersetupId}/instructions`,
      method: "get",
    },
    options
  );
...
export const getAdminGetProvidersetupInstructionsKey = (
  providersetupId: string
) => [`/api/v1/admin/providersetups/${providersetupId}/instructions`];

export type AdminGetProvidersetupInstructionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetProvidersetupInstructions>>
>;
export type AdminGetProvidersetupInstructionsQueryError = ErrorType<unknown>;

export const useAdminGetProvidersetupInstructions = <
  TError = ErrorType<unknown>
>(
  providersetupId: string,
  options?: {
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getAdminGetProvidersetupInstructionsKey(providersetupId)
        : null);
  const swrFn = () =>
    adminGetProvidersetupInstructions(providersetupId, requestOptions);
...
export const adminValidateProvidersetup = (
  ...
  return customInstanceCommonfate<ProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetups/${providersetupId}/validate`,
      method: "post",
    },
    options
  );
...
export const adminCompleteProvidersetup = (
  ...
  return customInstanceCommonfate<CompleteProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetups/${providersetupId}/complete`,
      method: "post",
    },
    options
  );
...
export const adminSubmitProvidersetupStep = (
  ...
  return customInstanceCommonfate<ProviderSetupResponseResponse>(
    {
      url: `/api/v1/admin/providersetups/${providersetupId}/steps/${stepIndex}/complete`,
      method: "put",
      headers: { "Content-Type": "application/json" },
...
export const getAdminGetIdentityConfigurationKey = () => [
  `/api/v1/admin/identity`,
];

export type AdminGetIdentityConfigurationQueryResult = NonNullable<
  Awaited<ReturnType<typeof adminGetIdentityConfiguration>>
>;
export type AdminGetIdentityConfigurationQueryError =
  ErrorType<ErrorResponseResponse>;

export const useAdminGetIdentityConfiguration = <
  TError = ErrorType<ErrorResponseResponse>
>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof adminGetIdentityConfiguration>>,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getAdminGetIdentityConfigurationKey() : null));
