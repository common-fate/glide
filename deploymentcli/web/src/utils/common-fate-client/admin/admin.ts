...
export const useAdminListProvidersv2 = <TError = ErrorType<ErrorResponseResponse>>(
  options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof adminListProvidersv2>>, TError> & { swrKey?: Key, enabled?: boolean }, request?: SecondParameter<typeof customInstanceCommonfate> }
...
export const useAdminGetProviderv2 = <TError = ErrorType<ErrorResponseResponse>>(
 providerId: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof adminGetProviderv2>>, TError> & { swrKey?: Key, enabled?: boolean }, request?: SecondParameter<typeof customInstanceCommonfate> }
...
export const adminListProviderArgOptions = (
 ...
 options?: SecondParameter<typeof customInstanceCommonfate>) => {
      return customInstanceCommonfate<ArgOptions>(
