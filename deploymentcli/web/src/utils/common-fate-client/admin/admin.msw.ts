...
export const getAdminListAccessRulesMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      ...
      with: {
        cldcm8qbc0003xcs7bkx1eo2e: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cldcm8qbc0002xcs7f83dh4i9: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
    ...
    timeConstraints: {
      maxDurationSeconds: faker.datatype.number({ min: 60, max: 15724800 }),
    },
...
export const getAdminCreateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cldcm8qbf0005xcs7f7493gy2: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cldcm8qbf0004xcs77i0775xn: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cldcm8qbu0007xcs7axml5cfa: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cldcm8qbu0006xcs7b5p4ac28: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminUpdateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cldcm8qbx0009xcs78iea33iz: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cldcm8qbw0008xcs78xka3ki2: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminArchiveAccessRuleMock = () => ({
  id: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement(Object.values(AccessRuleStatus)),
  groups: Array.from(
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cldcm8qcc000bxcs788lk0pch: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cldcm8qca000axcs76jlw816b: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleVersionsMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      provider: { id: faker.random.word(), type: faker.random.word() },
      with: {
        cldcm8qcl000dxcs7avaq4rfs: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cldcm8qcl000cxcs7gbxhc372: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
...
export const getAdminGetAccessRuleVersionMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cldcm8qct000fxcs7c3ik57cd: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cldcm8qct000excs7d9la623z: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetDeploymentVersionMock = () => ({
  version: faker.random.word(),
});
...
export const getAdminListUsersMock = () => ({
  users: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getAdminCreateUserMock = () => ({
  id: faker.random.word(),
  email: faker.random.word(),
  firstName: faker.random.word(),
  picture: faker.random.word(),
...
export const getAdminListGroupsMock = () => ({
  groups: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getAdminCreateGroupMock = () => ({
  name: faker.random.word(),
  description: faker.random.word(),
  id: faker.random.word(),
  memberCount: faker.datatype.number({ min: undefined, max: undefined }),
...
export const getAdminGetGroupMock = () => ({
  name: faker.random.word(),
  description: faker.random.word(),
  id: faker.random.word(),
  memberCount: faker.datatype.number({ min: undefined, max: undefined }),
...
export const getAdminUpdateGroupMock = () => ({
  name: faker.random.word(),
  description: faker.random.word(),
  id: faker.random.word(),
  memberCount: faker.datatype.number({ min: undefined, max: undefined }),
...
export const getAdminListProvidersMock = () =>
  Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({ id: faker.random.word(), type: faker.random.word() }));

export const getAdminGetProviderMock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
});

export const getAdminGetProviderArgsMock = () => ({
  cldcm8ql9000ixcs75yp4goya: {
    id: faker.random.word(),
    title: faker.random.word(),
    description: faker.helpers.arrayElement([faker.random.word(), undefined]),
    ruleFormElement: faker.helpers.arrayElement([
      "INPUT",
      "MULTISELECT",
      "SELECT",
    ]),
    requestFormElement: faker.helpers.arrayElement([
      faker.helpers.arrayElement(["SELECT"]),
      undefined,
    ]),
    groups: faker.helpers.arrayElement([
      {
        cldcm8ql9000hxcs74bvy3jpz: {
          id: faker.random.word(),
          title: faker.random.word(),
...
export const getAdminListProviderArgOptionsMock = () => ({
  options: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
  ...
  groups: faker.helpers.arrayElement([
    {
      cldcm8qm0000jxcs786pcayki: Array.from(
        { length: faker.datatype.number({ min: 1, max: 10 }) },
        (_, i) => i + 1
      ).map(() => ({
        label: faker.random.word(),
        ...
        labelPrefix: faker.helpers.arrayElement([
          faker.random.word(),
          undefined,
        ]),
      })),
...
export const getAdminListProvidersetupsMock = () => ({
...
export const getAdminCreateProvidersetupMock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminListProvidersetupsv2Mock = () => ({
  providerSetups: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getAdminCreateProvidersetupv2Mock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminGetProvidersetupMock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminDeleteProvidersetupv2Mock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminGetProvidersetupv2Mock = () => ({
  id: faker.random.word(),
  team: faker.random.word(),
  name: faker.random.word(),
  version: faker.random.word(),
...
export const getAdminDeleteProvidersetupMock = () => ({
  id: faker.random.word(),
  team: faker.random.word(),
  name: faker.random.word(),
  version: faker.random.word(),
...
export const getAdminValidateProvidersetupMock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminCompleteProvidersetupMock = () => ({
  deploymentConfigUpdateRequired: faker.datatype.boolean(),
});

export const getAdminSubmitProvidersetupStepMock = () => ({
  id: faker.random.word(),
  type: faker.random.word(),
  version: faker.random.word(),
  status: faker.helpers.arrayElement([
...
export const getAdminGetIdentityConfigurationMock = () => ({
  identityProvider: faker.random.word(),
  administratorGroupId: faker.random.word(),
});
