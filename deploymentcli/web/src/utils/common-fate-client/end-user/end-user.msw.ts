...
export const getUserCreateFavoriteMock = () => ({
  ...
  with: Array.from(
    ...
    cldcm8qxr000kxcs764yq2kc9: Array.from(
      { length: faker.datatype.number({ min: 1, max: 10 }) },
      (_, i) => i + 1
    ).map(() => faker.random.word()),
  })),
...
export const getUserGetFavoriteMock = () => ({
  ...
  with: Array.from(
    ...
    cldcm8qyb000lxcs73fpw79di: Array.from(
      { length: faker.datatype.number({ min: 1, max: 10 }) },
      (_, i) => i + 1
    ).map(() => faker.random.word()),
  })),
...
export const getUserUpdateFavoriteMock = () => ({
  ...
  with: Array.from(
    ...
    cldcm8qyd000mxcs72wc60tg1: Array.from(
      { length: faker.datatype.number({ min: 1, max: 10 }) },
      (_, i) => i + 1
    ).map(() => faker.random.word()),
  })),
