...
func (m *MockAccessRuleService) GetRule(arg0 context.Context, arg1 string, arg2 *identity.User, arg3 bool) (*rule.AccessRuleWithCanRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRule", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*rule.AccessRuleWithCanRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
