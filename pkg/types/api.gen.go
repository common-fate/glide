...
const (
	ApprovalMethodAUTOMATIC ApprovalMethod = "AUTOMATIC"

	ApprovalMethodREVIEWED ApprovalMethod = "REVIEWED"
)
...
type AdminListAccessRulesParams struct {
	...
	Status *AdminListAccessRulesParamsStatus `json:"status,omitempty"`
}
...
type AdminListRequestsParams struct {
	...
	Status *AdminListRequestsParamsStatus `json:"status,omitempty"`
...
type UserListRequestsParams struct {
	// omit this param to view all results
	Status *UserListRequestsParamsStatus `json:"status,omitempty"`
