...
func TestGetRequestWithGroupsWithTargetsForUser(t *testing.T) {
	...
	gid := "grp_abcd"
	tid := "gta_abcd"
	req := access.Request{ID: rid, GroupTargetCount: 1, RequestedBy: access.RequestedBy{ID: "usr_abcd"}}
	group := access.Group{ID: gid, RequestID: rid, RequestedBy: access.RequestedBy{ID: "usr_abcd"}}
	target := access.GroupTarget{ID: tid, GroupID: gid, RequestID: rid, RequestedBy: access.RequestedBy{ID: "usr_abcd"}}
	rid = "req_efgh"
	gid = "grp_efgh"
	tid = "gta_efgh"
