...
// DeploymentConfiguration The configuration for a Common Fate deployment.
type DeploymentConfiguration struct {
	// NotificationsConfiguration Notifications configuration for the deployment.
	NotificationsConfiguration NotificationsConfiguration `json:"notificationsConfiguration"`

	// ProviderConfiguration Configuration of all Access Providers.
	ProviderConfiguration ProviderMap `json:"providerConfiguration"`
}

// NotificationsConfiguration Notifications configuration for the deployment.
type NotificationsConfiguration struct {
	// Slack The Slack notification configuration.
...
// ProviderConfiguration Configuration settings for an individual Access Provider.
type ProviderConfiguration struct {
	Uses string            `json:"uses"`
	With map[string]string `json:"with"`
}

// ProviderMap Configuration of all Access Providers.
type ProviderMap map[string]ProviderConfiguration

// SlackConfiguration The Slack notification configuration.
type SlackConfiguration struct {
	// ApiToken The Slack API token. Should be a reference to secret in `awsssm://` format.
...
// UpdateProviderConfigurationJSONBody defines parameters for UpdateProviderConfiguration.
type UpdateProviderConfigurationJSONBody struct {
	// ProviderConfiguration Configuration of all Access Providers.
	ProviderConfiguration ProviderMap `json:"providerConfiguration"`
}

// UpdateProviderConfigurationJSONRequestBody defines body for UpdateProviderConfiguration for application/json ContentType.
type UpdateProviderConfigurationJSONRequestBody UpdateProviderConfigurationJSONBody
