...
// 			currentRequestRule: rule.AccessRule{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a"}},
// 			allRules:           []rule.AccessRule{{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_b"}}},
// 			clock:              clk,
// 			want:               false,
// 		},
// 		{
// 			name:               "request overlaps current active request fails",
// 			accessRequest:      access.Request{Rule: "rule_a", RequestedTiming: requests.Timing{StartTime: &now, Duration: time.Minute * 5}},
// 			upcomingRequests:   []access.Request{activeRequest},
// 			currentRequestRule: rule.AccessRule{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a"}},
// 			allRules:           []rule.AccessRule{{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a"}}},
// 			clock:              clk,
// 			want:               true,
// 		},
// 		{
// 			name:               "scheduled request overlaps current active request fails",
// 			accessRequest:      access.Request{Rule: "rule_a", RequestedTiming: requests.Timing{StartTime: &inOneMinute, Duration: time.Minute * 5}},
// 			upcomingRequests:   []access.Request{activeRequest},
// 			currentRequestRule: rule.AccessRule{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a"}},
// 			allRules:           []rule.AccessRule{{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a"}}},
// 			clock:              clk,
...
// 			accessRequest:      access.Request{Rule: "rule_a", RequestedTiming: requests.Timing{StartTime: &inOneMinute, Duration: time.Minute * 5}},
// 			upcomingRequests:   []access.Request{activeRequest},
// 			currentRequestRule: rule.AccessRule{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a", With: args1}},
// 			allRules:           []rule.AccessRule{{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a", With: args2}}},
// 			clock:              clk,
// 			want:               false,
// 		},
// 		{
...
// 			upcomingRequests:   []access.Request{activeRequest},
// 			currentRequestRule: rule.AccessRule{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a", With: args1}},
// 			allRules:           []rule.AccessRule{{ID: "rule_a", Target: rule.Target{TargetGroupID: "prov_a", With: args1}}},
// 			clock:              clk,
// 			want:               true,
// 		},
// 		{
...
// 					Status: "ACTIVE",
// 				},
// 				RequestedTiming: requests.Timing{StartTime: &now, Duration: time.Minute * 3},
