...
export const getAdminListTargetRoutesMock = () => ({
  ...
  next: faker.helpers.arrayElement([faker.random.word(), undefined]),
});

export const getUserListEntitlementsMock = () => ({
...
export const getUserListEntitlementTargetsMock = () => ({
  targets: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getUserRequestPreflightMock = () => ({
  id: faker.random.word(),
...
export const getUserListReviewsMock = () => ({
  requests: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getUserPostRequestsMock = () => ({
  id: faker.random.word(),
  purpose: {
    reason: faker.helpers.arrayElement([faker.random.word(), undefined]),
  },
  accessGroups: Array.from(
    ...
    id: faker.random.word(),
    requestId: faker.random.word(),
    status: faker.helpers.arrayElement(Object.values(RequestAccessGroupStatus)),
    time: {
      durationSeconds: faker.datatype.number({
        min: undefined,
        max: undefined,
