...
export const useListProviders = <
  TError = ErrorType<ErrorResponseResponse>
>(options?: {
  swr?: SWRConfiguration<Awaited<ReturnType<typeof listProviders>>, TError> & {
    swrKey?: Key;
    enabled?: boolean;
  };
  request?: SecondParameter<typeof customInstance>;
  ...
  const isEnabled = swrOptions?.enabled !== false;
  const swrKey =
    swrOptions?.swrKey ?? (() => (isEnabled ? getListProvidersKey() : null));
...
export const getGetProviderKey = (providerId: string) => [
...
export const useGetProvider = <TError = ErrorType<ErrorResponseResponse>>(
  providerId: string,
  options?: {
    swr?: SWRConfiguration<Awaited<ReturnType<typeof getProvider>>, TError> & {
      swrKey?: Key;
      enabled?: boolean;
    };
    request?: SecondParameter<typeof customInstance>;
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetProviderKey(providerId) : null));
...
export const getGetProviderArgsKey = (providerId: string) => [
  `/api/v1/admin/providers/${providerId}/args`,
];

export type GetProviderArgsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProviderArgs>>
>;
...
export const useGetProviderArgs = <TError = ErrorType<ErrorResponseResponse>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetProviderArgsKey(providerId) : null));
...
export const getListProviderArgOptionsKey = (
  providerId: string,
  argId: string,
  params?: ListProviderArgOptionsParams
) => [
...
export type ListProviderArgOptionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listProviderArgOptions>>
>;
export type ListProviderArgOptionsQueryError = ErrorType<ErrorResponseResponse>;

export const useListProviderArgOptions = <
  TError = ErrorType<ErrorResponseResponse>
>(
  providerId: string,
  argId: string,
  ...
  const swrKey =
    ...
    (() =>
      isEnabled
        ? getListProviderArgOptionsKey(providerId, argId, params)
        : null);
  const swrFn = () =>
    listProviderArgOptions(providerId, argId, params, requestOptions);
...
export type ListProvidersetupsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listProvidersetups>>
>;
export type ListProvidersetupsQueryError = ErrorType<unknown>;

export const useListProvidersetups = <TError = ErrorType<unknown>>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof listProvidersetups>>,
    TError
  > & { swrKey?: Key; enabled?: boolean };
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getListProvidersetupsKey() : null));
...
export const getGetProvidersetupKey = (providersetupId: string) => [
  `/api/v1/admin/providersetups/${providersetupId}`,
];

export type GetProvidersetupQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProvidersetup>>
>;
...
export const useGetProvidersetup = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getGetProvidersetupKey(providersetupId) : null));
...
export const getGetProvidersetupInstructionsKey = (providersetupId: string) => [
  `/api/v1/admin/providersetups/${providersetupId}/instructions`,
];

export type GetProvidersetupInstructionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProvidersetupInstructions>>
>;
...
export const useGetProvidersetupInstructions = <TError = ErrorType<unknown>>(
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() =>
      isEnabled ? getGetProvidersetupInstructionsKey(providersetupId) : null);
  const swrFn = () =>
    getProvidersetupInstructions(providersetupId, requestOptions);
...
export type IdentityConfigurationQueryResult = NonNullable<
  Awaited<ReturnType<typeof identityConfiguration>>
>;
export type IdentityConfigurationQueryError = ErrorType<ErrorResponseResponse>;

export const useIdentityConfiguration = <
  TError = ErrorType<ErrorResponseResponse>
>(options?: {
  swr?: SWRConfiguration<
    Awaited<ReturnType<typeof identityConfiguration>>,
  ...
  const swrKey =
    swrOptions?.swrKey ??
    (() => (isEnabled ? getIdentityConfigurationKey() : null));
