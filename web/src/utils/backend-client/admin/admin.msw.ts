...
export const getAdminListAccessRulesMock = () => ({
  accessRules: Array.from(
    ...
    priority: faker.datatype.number({ min: 0, max: undefined }),
  })),
...
export const getAdminListHandlersMock = () => ({
  res: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
...
export const getAdminGetTargetGroupMock = () => ({
  id: faker.random.word(),
  schema: {
    clgu4luom00051w4511mp2cup: {
      id: faker.random.word(),
      title: faker.random.word(),
...
export const getAdminListTargetGroupsMock = () => ({
  targetGroups: Array.from(
    { length: faker.datatype.number({ min: 1, max: 10 }) },
    (_, i) => i + 1
  ).map(() => ({
    id: faker.random.word(),
    schema: {
      clgu4luop00061w453xg168b0: {
        id: faker.random.word(),
        title: faker.random.word(),
        description: faker.helpers.arrayElement([
          faker.random.word(),
...
export const getAdminCreateTargetGroupMock = () => ({
  id: faker.random.word(),
  schema: {
    clgu4luoq00071w4505nifdgz: {
      id: faker.random.word(),
      title: faker.random.word(),
      description: faker.helpers.arrayElement([faker.random.word(), undefined]),
    },
...
export const getAdminCreateTargetGroupLinkMock = () => ({
  targetGroupId: faker.random.word(),
  handlerId: faker.random.word(),
  kind: faker.random.word(),
  priority: faker.datatype.number({ min: undefined, max: undefined }),
