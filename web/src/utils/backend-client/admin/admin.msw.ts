...
export const getAdminListAccessRulesMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      ...
      with: {
        cl9dsgsic0007kponavmqc5uw: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cl9dsgsic0006kponbv0mb91t: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
...
export const getAdminCreateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9dsgsic0009kpon0qpv242k: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9dsgsic0008kponhbkfbnzr: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9dsgsig000bkpon6fuw4oih: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9dsgsig000akpon7agr6zhv: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminUpdateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9dsgsih000dkpon3hu4g3xd: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9dsgsih000ckpon0cqi7364: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleVersionsMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      provider: { id: faker.random.word(), type: faker.random.word() },
      with: {
        cl9dsgsil000hkpon4qr52s02: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cl9dsgsil000gkponaqzi0avk: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
...
export const getAdminGetAccessRuleVersionMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9dsgsio000jkpongjqoc7rn: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9dsgsio000ikpon84v9ceaq: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getCreateGroupMock = () => ({
  name: faker.random.word(),
  description: faker.random.word(),
  id: faker.random.word(),
  memberCount: faker.datatype.number({ min: undefined, max: undefined }),
...
export const getListProviderArgOptionsMock = () => ({
  ...
  groups: faker.helpers.arrayElement([
    {
      cl9dsgsj6000okponcgmo374e: Array.from(
        { length: faker.datatype.number({ min: 1, max: 10 }) },
        (_, i) => i + 1
      ).map(() => ({
...
export const getCompleteProvidersetupMock = () => ({
...
export const getIdentityConfigurationMock = () => ({
