...
export const getAdminListAccessRulesMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      ...
      with: {
        cl9f3idqw0003zb491so90iit: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cl9f3idqv0002zb49hepi85pt: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
...
export const getAdminCreateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9f3idqw0005zb49a6d18zxw: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9f3idqw0004zb49h298hcaa: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9f3idr10007zb49av515ym3: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9f3idr10006zb494x0ofg7b: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminUpdateAccessRuleMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9f3idr20009zb491tmpfwu8: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9f3idr20008zb4975vb1h1h: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getAdminGetAccessRuleVersionsMock = () => ({
  accessRules: Array.from(
    ...
    target: {
      provider: { id: faker.random.word(), type: faker.random.word() },
      with: {
        cl9f3idr6000dzb496kpadtam: {
          values: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
          groupings: {
            cl9f3idr6000czb496qo87liz: Array.from(
              { length: faker.datatype.number({ min: 1, max: 10 }) },
              (_, i) => i + 1
            ).map(() => faker.random.word()),
          },
...
export const getAdminGetAccessRuleVersionMock = () => ({
  ...
  target: {
    provider: { id: faker.random.word(), type: faker.random.word() },
    with: {
      cl9f3idr8000fzb490u2m1s5w: {
        values: Array.from(
          { length: faker.datatype.number({ min: 1, max: 10 }) },
          (_, i) => i + 1
        ).map(() => faker.random.word()),
        groupings: {
          cl9f3idr8000ezb49g44o5kbs: Array.from(
            { length: faker.datatype.number({ min: 1, max: 10 }) },
            (_, i) => i + 1
          ).map(() => faker.random.word()),
        },
...
export const getListProviderArgOptionsMock = () => ({
  ...
  groups: faker.helpers.arrayElement([
    {
      cl9f3ids1000jzb493c1x9l6d: Array.from(
        { length: faker.datatype.number({ min: 1, max: 10 }) },
        (_, i) => i + 1
      ).map(() => ({
