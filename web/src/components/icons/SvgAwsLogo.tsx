...
function SvgAwsLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      id="Amazon_Web_Services_Logo_(1)_svg__Layer_1"
    ...
    >
      <style>
        {
          ".Amazon_Web_Services_Logo_(1)_svg__st1{fillRule:evenodd;clipRule:evenodd;fill:#f90}"
        }
      </style>
      <path
      ...
      />
      <path
        className="Amazon_Web_Services_Logo_(1)_svg__st1"
